    ...
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                // Generate C/C++ code from the syntax tree generated by the parser.
                ...
                if (Verbose)
                {
                    // Print the generated code to the console if the verbose flag is set.
        ...
        private static void ParseCommandArguments(string[] args)
        {
            foreach (var arg in args)
            {
                switch (arg)
                {
                    ...
                    case "-emit-c":
                        // Emit the generated code to a file. Return without compiling the source file.
                        EmitC = true;
                        // output file name won't follow this flag.
                        Output = false;
                        break;
